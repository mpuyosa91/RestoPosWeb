 ...
 */
package com.mpuyosa91.posaplications.RestoPosWeb._02_Views._3_Personal.Listar;
...
public class ListFrame extends JFrame implements IFrame {
    ...
    public ListFrame(MainFrame contextFrame, UUID site_id) {
        super();
        ...
        this.LeftPanel_Rectangle = new Rectangle(0, navigationPanel_ySize, (xSize - 8), ySize - navigationPanel_ySize);
    ...
    private void createContentPanel() {
        ...
        listScroll.setBounds(new Rectangle(0, navigationPanel_ySize, (xSize - 8), ySize - navigationPanel_ySize - 8));
